function getAvailableHeroes() {
    ...
    function getUpgradeEffectDesc(effect) {
      ...
      if (op === "mul" || op === "multiply") {
        if (statKey === "move_speed" || statKey === "bullet_speed" || statKey === "attack") {
...
<div class="game-over-panel">
  ...
  <button type="button" id="gameOverBackBtn">回主界面</button>
    ...
    function spawnBulletBurst(dirX, dirY, now, count, spreadRad, speed, damage, pierceRemaining) {
    ...
    function shootAtClientPoint(clientX, clientY, nowOverride) {
      ...
      spawnBulletBurst(dirX, dirY, now, count, spreadRad, speed, damage, pierceRemaining);
      ...
      for (let i = 0; i < markedTargets.length; i += 1) {
        ...
        spawnBulletBurst(tx / tLen, ty / tLen, now, 1, 0, speed, damage, pierceRemaining);
      }
